...
public class MainActivity extends AppCompatActivity {
    ...
    static final String SHARED_PREFERENCE_USERID_KEY = "com.kristineb.gymlog.SHARED_PREFERENCE_USERID_KEY";

    static final String SAVED_INSTANCE_STATE_USERID_KEY = "com.kristineb.gymlog.SAVED_INSTANCE_STATE_USERID_KEY";

    static final String SHARED_PREFERENCE_USERID_VALUE = "com.kristineb.gymlog.SHARED_PREFERENCE_USERID_VALUE";
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        sharePrefEditor.putInt(MainActivity.SHARED_PREFERENCE_USERID_KEY, loggedInUserId);
